/**
 * Icon — thin SVG icon system (1.5px stroke, rounded ends)
 * Usage: <Icon name="home" size={20} className="text-brand-400" />
 */
const ICONS = {
  // Navigation
  home: (
...
export default function Icon({ name, size = 20, className = '', strokeWidth = 1.5, fill = false }) {
